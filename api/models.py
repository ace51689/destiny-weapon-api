...
class StaticWeapon(models.Model):
	...
	column_one_hash = models.ForeignKey('PlugSet', related_name='column_one', on_delete=models.SET_NULL, null=True,
	                                    blank=True)
	column_two_hash = models.ForeignKey('PlugSet', related_name='column_two', on_delete=models.SET_NULL, null=True,
	                                    blank=True)
	column_three_hash = models.ForeignKey('PlugSet', related_name='column_three', on_delete=models.SET_NULL, null=True,
	                                      blank=True)
	column_four_hash = models.ForeignKey('PlugSet', related_name='column_four', on_delete=models.SET_NULL, null=True,
	                                     blank=True)
	origin_trait_hash = models.ForeignKey('PlugSet', related_name='origin_trait', on_delete=models.SET_NULL, null=True,
	                                      blank=True)
